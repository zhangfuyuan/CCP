...
<script>
  ...
  import { getOfficeTreeData } from '@/datas'
  import { mapGetters } from 'vuex'

  let id = 1000;
  let tree = getOfficeTreeData();
      ...
      updateDistributionPoints(params) {
        ...
        if (params) {
          ...
          params.sunList.map(item => {
            ...
            node.openWisdomPid = item.openWisdomPid;
          });
          ...
          node.totalPoints = params.curOfficeInfo.totalPoints;
          node.isWisdom = params.curOfficeInfo.isWisdom;
