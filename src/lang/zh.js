export default {
  ...
  deviceManager: {
    ...
    notLockScreen: "不锁屏",
    lockScreenMode: "锁屏方式",
    lockScreenChange: "更改方式",
    lockScreenImage: "锁屏图像",
    default: "默认图像",
    defaultM:"默认",
    customize:"自定义",
    customImage: "自定义图像",
    ...
    bootChannel: "开机通道",
    setBootChannel: "设置开机通道",
    untypedPrompt: "系统未录入终端端口，请通知管理员更新云功能配置",
    type: "类型",
    machine: "台",
    untypedType: "未录入类型",
    cloudFeature: "云功能",
  ...
  cloudConfig : {
    cloudFeatureConfigurationTips1: "云功能配置变更后请手动【刷新】更新配置数据 ( 自建服务器请导入 JSON 配置 )",
    cloudFeatureConfigurationTips2: "当前平台系统涉及配置变更功能 : 【通道设置】",
    cloudFeatureConfigurationTips3: "云功能 * 通过小百合云平台配置功能参数",
    lastUpdateTime: "上次更新时间",
    gettingConfigurationData: "正在获取配置数据...",
    failGet: "获取失败",
    failGetTips: "未能连接到云平台，请再次尝试或导入JSON",
    importJson: "导入 JSON",
    importJsonTips: "在文本框内输入小百合云平台产品JSON格式协议",
    updateConfigurationData: "更新配置数据",
    refresh: "刷新",
    selfBuiltServer: "自建服务器",
    close: "关闭",
    inputJson: "输入JSON",
    verifyJSONTips1: "JSON 格式错误 , 请检查确认",
    verifyJSONTips2: "非法的 JSON , 请检查确认",
  },
  errorPage: {
