export default {
  ...
  deviceManager: {
    ...
    offices: "offices",
    allClear: "All empty",
    searchOfficeName: "Search department name/ID",
    loading: "Loading",
    atAll: "At all",
    ...
    lockScreenImage: "Lock screen image",
    lockScreenChange: "Change mode",
    ...
    currentImage:"Current Mode",
    channelSettings: "Channel settings",
    bootChannel: "Boot channel",
    setBootChannel: "Set boot channel",
    untypedPrompt: "The system has not entered the terminal port. Please inform the administrator to update the cloud function configuration",
    type: "Type",
    machine: "Machine",
    untypedType: "Untyped type",
    cloudFeature: "Cloud feature",
  },
  planManager: {
    ...
    timeErrorTTS:"Start time needs to be less than the end time"
  },
  accountManager: {
    total: "Total",
    account: "Accounts",
  ...
  officeManager: {
    newSubOffice: "Create",
    pleaseSelectMechanism: "Please select a department",
    intelligentAllocationPointsMode: "Auto-assign",
    id: "ID",
    distributionPoints: "Liscense",
    modifyName: "Rename",
    ...
    serverAuthentication: "Server approve",
    certification: "Certification",
    verificationCode: "Verification code",
    pleaseEnterServerAuthenticationName: "Please enter the server approve name",
    pleaseEnterServerVerificationCode: "Please enter the server verification code",
    authentication: "Approve",
    superior: "Upper",
    distributablePoints: "Available liscense",
    assignedPoints: "Used liscense",
    deviceNumber: "Device Num.",
    mechanismTotalPoints: "Total",
    ...
    afterAnti: "After re-approve, server approve will be cancelled and the device cannot be connected",
    anti: "Re-approve",
    organizationNameEmpty: "Organization name empty",
    authenticationCodeError: "Approve code error",
    authenticationNameError: "Wrong approve name",
    parentOfficeIsNull: "Parent department is null",
    officeIsNull: "Department is null",
    pointError: "Point error",
    refreshCertification: "Refresh",
    cannotContinueIncreasePointTips: "Because upper organization point is insufficient, cannot continue to increase point!",
  ...
  cloudConfig : {
    cloudFeatureConfigurationTips1: "Update the configuration data manually [refresh] after the configuration change of cloud function (import the JSON configuration of the self-built server)",
    cloudFeatureConfigurationTips2: "The current platform system involves configuration changes: [Channel Settings]",
    cloudFeatureConfigurationTips3: "Cloud function * configures the function parameters through lilium cloud platform",
    lastUpdateTime: "Last update time",
    gettingConfigurationData: "Getting configuration data...",
    failGet: "Fail to get",
    failGetTips: "Unable to connect to the cloud platform, try again or import JSON",
    importJson: "Import JSON",
    importJsonTips: "Enter the product JSON format protocol of lilium cloud platform in the text box",
    updateConfigurationData: "Update configuration data",
    refresh: "Refresh",
    selfBuiltServer: "Self-built server",
    close: "Close",
    inputJson: "Input JSON",
    verifyJSONTips1: "JSON format error, please check for confirmation",
    verifyJSONTips2: "Illegal JSON, please check for confirmation",
  },
  errorPage: {
